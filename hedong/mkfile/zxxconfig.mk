# Default target
exe : $(TARGET_OBJS)
	$(DEFAULT_BUILD) -L$(COMMONINCLUDEHOME) -o $(TARGET_NAME) $(TARGET_OBJS) $(COMMONLIB) $(PLATFORM_LINK_FLAG) $(USER_LINK_FLAG)
	#mv $(TARGET_NAME) ../bin
	#cp $(TARGET_NAME) ../bin
lib : $(TARGET_OBJS)
...
sl  : $(TARGET_OBJS)
	$(DEFAULT_BUILD) $(PLATFORM_LINK_FLAG) -G  -o $(TARGET_NAME)  $(TARGET_OBJS) 
...
#Version
VERSION=-D_VERSION_HN_
MONTH_FLAG=-D_TOTAL_MONTH_
...
# Library settting
COMMONINCLUDEHOME=/data/newdata2/wjjs/common/lib/
...
COMPILE_NORMAL=$(CXX_COMPILER) -g -w -c -xarch=v8 $(PLATFORM_COMPILE_FLAG) $(USER_COMPILE_FLAG) $(INCLUDE)  $(COMPILE_IOSTREAM_FLAG) $(COMPILE_TEMPLATE_FLAG) $(VERSION) $(MONTH_FLAG) $(LIB_TYPE) $(USER_DEFINE)
...
include /data/newdata2/wjjs/common/mkfile/platform.mk
# Suffix define
.SUFFIXES:
