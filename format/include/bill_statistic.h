#ifndef _Bill_statistic_h_
#define _Bill_statistic_h_ 1
...
private:
    ...
    struct S_BillStat  *p_stat; 
    long   max_count;
    char  Month[2][16];
    S_H_BillStat p_H_stat[2][MAX_H_BILL_STAT];
    
    char NowMonth[16];
    
public:
    C_BillStat(){max_count=0;}
    C_BillStat( char * ,int index);
    int Init(char *,int);
    ~C_BillStat( );
    int GetTime();
    int  AddItem( char * );
